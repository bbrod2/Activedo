...
<body>
	...
	<div class="col span-1-of-2">
		...
		<div class="row class= text-container">
			<p class="stop-header">Please Consult Your Doctor Before Moving
				on</p>
			<p class="stop-description">Here at Activedo, we care about your
				saftey and encourage you to see your doctor before starting any diet
				or training programs. Then follow the doctors guidlines on how to
				proceed safely.</p>
		</div>
	</div>
</body>
